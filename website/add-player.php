    ...
    <body id="page-top">
        ...
        <header class="masthead bg-dark text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <form action="add-player-post.php" method="post">
                <input type="text" id="input-add-player" class="form-control" name="identifier" placeholder="steam:110000000000000" required>
                <div class="space-input-login"></div>
                <input type="text" id="input-add-player" class="form-control" name="discord_id" placeholder="Discord ID" required>
                <div class="space-input-login"></div>
                <button type="submit" class="btn btn-success" name="formconnexion">Send</button>
                </form>
