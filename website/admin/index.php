    ...
    <body id="page-top">
        ...
        <header class="masthead bg-dark text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="masthead-heading text-uppercase mb-0">Moderators</h1>
...
<table id="myTable">
  ...
  $reponse = $bdd->query('SELECT * FROM users_whitelist ORDER BY id DESC');
  ...
  <tr>
    <td><?php echo $data['username']; ?></td>
                                                     ...
                                                     <?php
        echo '<td>
                                                             <button type="submit" name="deletemoderator" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                     </td>';
    ?>
                                                </form>
  </tr>
